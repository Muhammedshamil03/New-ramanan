...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ML_LINKS_01')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ML_LINKS_01')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(-1001569522112)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ML_LINKS_01')
